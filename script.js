...
let acButtonToC = document.getElementById("c");
let globalVarA = 0;
let globalVarB = 0;
let result = 0;
let selectNumber = 0;
...
function firstNumber(element) {
  ...
  if (globalFloatSelector === 0) {
    ...
    globalVarA = parseFloat(
      (globalVarA + localvarC / localVarB).toFixed(globalFloatSelector)
    );
    globalFloatSelector++;
  }
  result = globalVarA;
...
function secondNumber(element) {
  ...
  if (globalFloatSelector === 0) {
    ...
    localVarB = Math.pow(10, globalFloatSelector);
    globalVarB = parseFloat(
      (globalVarB + localvarC / localVarB).toFixed(globalFloatSelector)
    );
    globalFloatSelector++;
  }
  result = clacResult();
